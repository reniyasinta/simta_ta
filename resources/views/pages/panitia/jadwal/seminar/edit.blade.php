    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item"><a href="{{ route('panitia.jadwal.jenis.index', ['jenis' => $jadwal->jenis_acara]) }}">Jadwal {{ ucfirst($jadwal->jenis_acara) }}</a></div>
        ...
        <div class="card">
            <div class="card-header">
                <h4>Form Edit Jadwal {{ ucfirst($jadwal->jenis_acara) }}</h4>
            </div>
            <div class="card-body">
                <form action="{{ route('panitia.jadwal.update', $jadwal->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="text-end mt-4">
                        ...
                        <a href="{{ route('panitia.jadwal.jenis.index', ['jenis' => $jadwal->jenis_acara]) }}" class="btn btn-secondary">Kembali</a>
                    </div>
                </form>
            </div>
        </div>
