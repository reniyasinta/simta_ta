<div class="main-sidebar sidebar-style-2">
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            <li><a class="nav-link" href="{{ url('jadwal') }}"><i class="far fa-calendar-alt"></i> <span>Jadwal Seminar</span></a></li>
            <li><a class="nav-link" href="{{ url('jadwal') }}"><i class="far fa-calendar-alt"></i> <span>Jadwal Sidang</span></a></li>
            ...
            <li><a class="nav-link" href="{{ route('admin.users') }}"><i class="fas fa-user"></i> <span>Semua User</span></a></li>
        </ul>
