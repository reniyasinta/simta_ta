...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('sempro', function (Blueprint $table) {
            ...
            $table->string('proposal_ta')->nullable();
            $table->string('form_persetujuan_sempro')->nullable();
            $table->string('berita_acara_sempro')->nullable();
            $table->enum('status_proposal_ta_dospem1', ['Menunggu', 'Revisi', 'Disetujui'])->default('Menunggu');
            $table->enum('status_proposal_ta_dospem2', ['Menunggu', 'Revisi', 'Disetujui'])->default('Menunggu');
