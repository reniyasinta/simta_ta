...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\laragon\www\simta-project\simtaehe\public\storage' => 'string',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.C:\\laragon\\www\\simta-project\\simtaehe\\public\\storage','logging.default','logging.deprecations.channel',
...
'generated::0uHVedEaHyuupRCy','auth.login','login','generated::7X8Z30KT1mfitHQA','logout',
'password.request','register','generated::S1Ee1lzEpLjb2SiL','dashboard','admin.dashboard',
'admin.users','admin.create','admin.store','admin.edit','admin.update',
'admin.destroy','admin.import','admin.import.store','admin.surat.index','admin.surat.edit',
'admin.surat.update','admin.surat.download','panitia.dashboard','panitia.pengajuan.index','panitia.pengajuan.edit',
'panitia.pengajuan.update','pages.panitia.berkas.index','pages.panitia.berkas.create','panitia.berkas.store','pages.panitia.berkas.edit',
'panitia.berkas.update','panitia.berkas.destroy','jadwal.index','jadwal.seminar.index','jadwal.sidang.index',
'jadwal.yudisium.index','jadwal.create','jadwal.store','jadwal.edit','jadwal.update',
'jadwal.destroy','jadwal.import.form','jadwal.import','jadwal.template','panitia.kuota.index',
'panitia.kuota.update','dosen.dashboard','dosen.profile','dosen.profile_edit','dosen.profile.update',
'dosen.validasi','dosen.validasi.submit','dosen.bimbingan','mahasiswa.dashboard','mahasiswa.profile',
'mahasiswa.profile.update','mahasiswa.profile_edit','mahasiswa.berkas.index','mahasiswa.berkas.create','mahasiswa.berkas.store',
'mahasiswa.berkas.edit','mahasiswa.berkas.update','mahasiswa.berkas.destroy','mahasiswa.berkas.download','pengajuan.index',
'pengajuan.create','pengajuan.store','kelompok.index','kelompok.create','kelompok.store',
'mahasiswa.fetchNama','mahasiswa.surat.index','mahasiswa.surat.create','mahasiswa.surat.store','mahasiswa.surat.download',
'mahasiswa.jadwal.index','mahasiswa.undangan.index','mahasiswa.undangan.create','mahasiswa.undangan.store','template.user',
'storage.local',);
        registerArgumentsSet('views', 
'components.auth-footer','components.auth-header','components.error-footer','components.footer','components.header',
'components.sidebar','layouts.alert','layouts.app','layouts.auth','layouts.error',
'pages.admin.create','pages.admin.dashboard','pages.admin.edit','pages.admin.import','pages.admin.surat.edit',
'pages.admin.surat.index','pages.admin.users','pages.auth.auth-login','pages.blank-page','pages.dosen.bimbingan.index',
'pages.dosen.dashboard','pages.dosen.profile','pages.dosen.profile_edit','pages.dosen.validasi.index','pages.mahasiswa.berkas.index',
'pages.mahasiswa.dashboard','pages.mahasiswa.jadwal.index','pages.mahasiswa.kelompok.create','pages.mahasiswa.kelompok.index','pages.mahasiswa.pengajuan.create',
'pages.mahasiswa.pengajuan.daftar_pengajuan','pages.mahasiswa.pengajuan.index','pages.mahasiswa.profile','pages.mahasiswa.profile_edit','pages.mahasiswa.surat.create',
'pages.mahasiswa.surat.index','pages.mahasiswa.undangan.create','pages.mahasiswa.undangan.index','pages.panitia.berkas.create','pages.panitia.berkas.edit',
'pages.panitia.berkas.index','pages.panitia.dashboard','pages.panitia.jadwal.import','pages.panitia.jadwal.seminar.create','pages.panitia.jadwal.seminar.edit',
'pages.panitia.jadwal.seminar.index','pages.panitia.jadwal.sidang.create','pages.panitia.jadwal.sidang.index','pages.panitia.jadwal.yudisium.create','pages.panitia.jadwal.yudisium.edit',
'pages.panitia.jadwal.yudisium.index','pages.panitia.kuota.index','pages.panitia.pengajuan.edit','pages.panitia.pengajuan.index','welcome',
